<aside class="sidebar">
    ...
    <div class="sidebar-nav">
        <ul>
            ...
            {{-- Patients - Accessible aux admins et médecins avec fonctionnalités étendues --}}
            ...
            @if(auth()->user()->role->nom === 'admin' || auth()->user()->role->nom === 'medecin')
            <li class="{{ Route::is('alerts.*') ? 'active' : '' }}">
            ...
            <li class="{{ Route::is('sensors.*') ? 'active' : '' }}">
            ...
            <li class="{{ Route::is('utilisateurs.*') || Route::is('services.*') ? 'active' : '' }}">
                <a href="{{ route('utilisateurs.index') }}"><i class="fas fa-users-cog"></i> <span>Administration</span></a>
            </li>
            @endif
