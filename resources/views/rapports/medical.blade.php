...
@section('title', 'Rapports Médicaux')

@section('content')
<div class="reports-modern-container">
    <div class="reports-header">
        <div class="reports-title">
            <div class="icon" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a52 100%);">
                <i class="fas fa-user-md"></i>
            </div>
            <h1>Rapports Médicaux</h1>
        </div>
        
        <form action="{{ route('reports.medical') }}" method="GET" class="filters-form">
            <div class="filters-section">
                ...
                <div class="filter-actions">
                    ...
                    <a href="{{ route('reports.generate', ['type' => 'medical']) }}" class="btn-secondary">
    ...
    <div class="recent-reports-section">
        <div class="section-header">
            <h2 class="section-title">
                <i class="fas fa-user-md"></i> Rapports Médicaux
            </h2>
        </div>
                ...
                <tbody>
                    @forelse($medicalReports ?? [] as $report)
                        <tr>
                            ...
                            <td>{{ $report->diagnostic ?? 'Consultation générale' }}</td>
                            <td>
